 ...
 * Uses {@link ContractService} for business logic and {@link ContractMapper} for DTO mapping.
 */
@RestController
...
public class ContractController extends BaseController{
    ...
    public ResponseEntity<ContractDTO> updateContractCost(
        ...
        Optional<ContractDTO> updated = contractService.findById(contractId)
     ...
     */
    private Optional<? extends Client> resolveClient(Long clientId, ClientType clientType) {
        return switch (clientType) {
            case PERSON -> personService.getPersonById(clientId);
            case COMPANY -> companyService.getCompanyById(clientId);
        };
    }
}
