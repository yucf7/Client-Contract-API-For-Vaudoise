 ...
 * This service uses {@link PersonService} and {@link CompanyService} to retrieve
...
public class ClientResolverService {
    ...
    /**
     * Resolves a {@link Client} entity based on the provided {@link ClientType} and client ID.
     * 
     * @param type The type of client to resolve (either {@link ClientType#PERSON} or {@link ClientType#COMPANY}).
    ...
    public Client resolveClient(ClientType type, Long id) {
        return switch (type) {
            ...
            case COMPANY -> companyService.getEntityById(id)
